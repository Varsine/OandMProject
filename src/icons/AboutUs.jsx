const AboutUs = ({ ...rest }) => (
  <svg
    ...
    {...rest}
  >
    <g filter="url(#about0_b)">
      <circle
        cx="25"
        cy="25"
        r="24.75"
        stroke="url(#about0_linear)"
        strokeWidth="0.5"
      />
    </g>
    <path
    ...
    <defs>
      ...
      >
        <feFlood floodOpacity="0" result="aboutImageFix" />
        <feGaussianBlur in="aboutImage" stdDeviation="25" />
        <feComposite
          in2="SourceAlpha"
          operator="in"
