const AboutUsHover = ({ ...rest }) => (
  <svg
    ...
    {...rest}
  >
    <g filter="url(#aboutHover0_b)">
      <circle cx="25" cy="25" r="25" fill="url(#aboutHover0_linear)" />
    </g>
    <path
    ...
    <defs>
      ...
      >
        ...
        <feComposite
          in2="SourceAlpha"
          operator="in"
          result="abotuHoverEffect1_backgroundBlur"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="abotuHoverEffect1_backgroundBlur"
          result="shape"
        />
      </filter>
      <linearGradient
        id="aboutHover0_linear"
        x1="25"
        y1="0"
        x2="25"
        y2="50"
